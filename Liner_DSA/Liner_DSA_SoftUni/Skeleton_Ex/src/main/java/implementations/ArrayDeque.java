...
public class ArrayDeque<E> implements Deque<E> {
    ...
    public void insert(int index, E element) {
        ...
        if (realIndex - this.head < this.tail - realIndex) {
            insertAtShiftLeft(realIndex - 1, element);
        } else {
            insertAtShiftRight(realIndex, element);
        }
    }
    ...
    private void insertAtShiftRight(int index, E element) {
    ...
    private void insertAtShiftLeft(int index, E element) {
